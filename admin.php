...
<head>
    ...
    <title>Rekrutmen Umana P2S3</title>
    ...
    <div class="wrapper">
        <nav class="navbar navbar-expand-md navbar-light bg-light py-1">
            <div class="container-fluid">
                ...
                <a class="navbar-brand me-auto text-danger" href="#">Rekrutmen<span class="text-warning">Umana</span></a>
        ...
        <div class="slider" id="sliders">
            <div class="slider-head">
                <div class="d-block pt-4 pb-3 px-3">
                    ...
                    <p class="fw-bold mb-0 lh-1 text-white">Rekrutmen Umana</p>
                    <small class="text-white">Pon Pes Salafiyah Syafi'iyah</small>
                </div>
            </div>
            <div class="slider-body px-1">
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link px-3" <?php echo isset($_GET['target']) && $_GET['target'] == 'calon' ? "active" : ""; ?> href="<?php echo base_url(); ?>admin.php?target=calon">
                        <i class="fa fa-solid fa-graduation-cap" aria-hidden="true"></i>Calon
                    </a>
                    <a class="nav-link px-3" <?php echo isset($_GET['target']) && $_GET['target'] == 'istikharah' ? "active" : ""; ?>" href="<?php echo base_url(); ?>admin.php?target=istikharah">
                        <i class="fa fa-home fa-lg box-icon" aria-hidden="true"></i>Istikharah
                    </a>
                    <a class="nav-link px-3" <?php echo isset($_GET['target']) && $_GET['target'] == 'berkas' ? "active" : ""; ?> href="<?php echo base_url(); ?>admin.php?target=berkas">
                        <i class="fa fa-user fa-lg box-icon" aria-hidden="true"></i>Berkas
                    </a>
                    <hr class="soft my-1 bg-white">
                    <hr class="soft my-1 bg-white">
